...
convened to-morrow morning in that district,
...
Our meeting with the natives to-morrow is now entirely dependent upon the elements,
...
should that evening be informed of my intention to visit them to-morrow;
...
to effect a landing upon the island to-day,
...
to insure which I found that I must land to-day at Gnatagnia,
attend the meeting there to-morrow,
...
At noon to-day, it was found from accurate calculation, that the island of Vavau,
