...
His work is honourable and glorious,--His righteousness endureth forever.
...
amongst the islands, for coconut oil, pearl shells, arrow root, etc.
...
to range amongst them, and collect coconut oil, arrow-root, etc.; there are, however,
