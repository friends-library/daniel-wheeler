...
'I never afterwards doubted f he however kept the matter entirely to himself,
...
Thirteen cart-loads of Bibles and Testaments have been sent off to-day for Moscow.
...
was to be introduced to Prince Galitzin to-day:
...
and crowneth us with loving-kindness and tender mercies.`"
