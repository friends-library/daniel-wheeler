...
in order that every thing that cannot stand the fire, may be removed out of the way,
...
those ties of love and long continued friendsbip,
...
and whose power is the same to-day as yesterday, and will for ever endure.
...
There is no part of our dear Redeemers doctrine, in my estimation, more plain, simple,
