...
[discrete]
=== Appendix A:
//Note in book here to insert this back into story
...
Fare`' Harbour.
//Should this apostrophe be kept here? It's in the original.
...
//And would this be 12 cents? I also may have pasted this in a couple of other placees on accident.
...
// I'm not sure what that line above is. "marai" in 799 in the book is underlined, not sure what it means. 
...
//Adroit here isn't archaic, but I had never heard of it. Should I leave it?
but the posture in which these amazons choose to exhibit,
violates every feeling of refinement.
//This last sentence is one of the best I've ever read. :D
...
//pa above is circled, but it matches the original. Not sure what it means.
...
//Pas above is the same in original. Don't know what it means. 
