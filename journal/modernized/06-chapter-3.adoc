...
there were any among the newly arrived sick,
...
He had looked at me among the rest,
...
whether any of the missing from their regiment were among the sick;
...
but was then broken up by the loaded wagons that passed that way.
...
in an open wagon, which the day following threatened a renewal of my illness;
...
Sometimes a wagon load of the wounded English would arrive at the hospital; when many,
...
and from the disastrous result of the campaign, however greatly this was to be deplored,
