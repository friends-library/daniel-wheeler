...
because every thing that defiles a man comes from there.
...
//So weigh in the above sentence is a sailing term meaning to heave up an anchor. It seems like it could be construed as a typo in the modernized, as "way" would seem more correct. I didn't change it because it's an actual term that's used correctly. What do you guys think?
