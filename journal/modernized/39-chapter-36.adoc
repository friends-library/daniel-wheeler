...
//Vouchsafed has been left in this whole book. It was never circled, but I had come across it before. Is it too late to change it now? Should I just leave this one too?
...
but rather have a tendency to promote His cause, by keeping me clothed with humility,"`Awake, O! north wind,
...
//arrear is circled, but I'm not sure it needs to be changed?
