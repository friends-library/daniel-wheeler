...
for the purpose of hoisting upon a lofty bamboo, or coconut tree,
...
the schools then broke up in an orderly manner, and proceeded towards the meetinghouse.
...
and I had largely to publish the glad tidings of the everlasting gospel among them,
to my own peace.
...
by faithfully testifying to that lovingkindness, which is better than life:
...
consisting principally of pearl shells, and coconut oil, was saved by the natives,
...
among the islands, for coconut oil, pearl shells, arrow root, etc.
...
A+++.+++ McDonald, and Alexander Cunningham accompanied us,
...
which comprise the Hervey group; but not one missionary among them all.
...
to range among them, and collect coconut oil, arrow-root, etc.; there are, however,
...
you have witnessed his lovingkindness,--you have seen
...
disagreed entirely with two first-rate charts we had on board;
