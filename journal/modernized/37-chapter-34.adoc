...
//Does the linter catch this after i submit the PR? or should it have caught it so I can break up line 1006 now?
...
--
//I think this is where this letter ends, not certain though.
[.asterism]
'''
